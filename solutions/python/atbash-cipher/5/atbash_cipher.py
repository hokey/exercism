...
def encode(plain_text):
    ...
    """
    cipher = str.maketrans(string.ascii_lowercase, CRYPT, string.punctuation + string.whitespace)
...
def decode(ciphered_text):
    ...
    """
    cipher = str.maketrans(CRYPT, string.ascii_lowercase, string.whitespace)
    text = ciphered_text.translate(cipher)
    return text
