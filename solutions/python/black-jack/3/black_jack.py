...
def value_of_ace(card_one, card_two):
    ...
    """
    result = ACE_VALUES[1]
    if card_one == 'A' and value_of_card(card_two) + ACE_VALUES[1] + ACE_VALUES[1] > POINT_THRESHOLD:
        result = ACE_VALUES[0]
    elif card_two == 'A' and value_of_card(card_one) + ACE_VALUES[1] + ACE_VALUES[1] > POINT_THRESHOLD:
        result = ACE_VALUES[0]
...
def is_blackjack(card_one, card_two):
    ...
    """
    result = False
    if card_one == 'A' and value_of_card(card_two) is SUIT_VALUE:
        result = True
    elif card_two == 'A' and value_of_card(card_one) is SUIT_VALUE:
        result = True
    return result
